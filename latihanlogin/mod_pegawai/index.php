<?php
$qdata = mysqli_query($koneksidb, "SELECT a.*, nama_divisi FROM mst_pegawai AS a INNER JOIN mst_divisi AS b ON a.divisi = b.iddivisi")or die(mysqli_error($koneksidb))
?>
<div class="container">
   <h2>Data Pegawai</h2>
   ...
   <table border="1" cellpadding='10'>
      ...
      <tr>
         ...
         <td>
            ...
            <a href="mod_pegawai/proses_delete.php?proses=delete&idpegawai=<?php echo $row['idpegawai']; ?>">Hapus</a>
         </td>
      </tr>
      <?php
        };
